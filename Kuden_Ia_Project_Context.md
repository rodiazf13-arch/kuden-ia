...
12. **Pipeline Kanban Inteligente (Ventas Autónomas):**
    Un tablero visual donde los leads se mueven **automáticamente** entre etapas (ej. Nuevo → Calificado → Propuesta → Cerrado) según la intención que la IA detecta en el chat. Convierte a Kuden en un CRM de ventas end-to-end.
